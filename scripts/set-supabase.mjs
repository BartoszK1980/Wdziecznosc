...
console.log('  2. Skonfiguruj wlasny serwer SMTP w ustawieniach Auth, potem wyslij szablony:');
console.log('     npx supabase config push --project-ref <ref>   (szablony: supabase/templates/)');
console.log('     Bez SMTP Supabase odrzuca zmiane szablonow i dostarcza poczte tylko zespolowi.');
